"""结构化输出：LLM 生成 Pydantic 模型的健壮调用（json-repair + tenacity 重试）。

迁移自 interview-agent `infrastructure/ai/structured_output.py`（AGPL-3.0），
import 裁剪为 servevo 本地 errors/ai_error/prompt_constants。
"""
...
from .ai_error import classify_ai_error
from .errors import BusinessException
from .prompt_constants import ANTI_INJECTION_INSTRUCTION
